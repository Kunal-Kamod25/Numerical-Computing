...
if "%choice%"=="6" goto run_main_updated
...
g++ -std=c++17 -Wall -IInclude -c Src/IterativeSolver.cpp -o Src/IterativeSolver.o
echo Creating Static Library (libmatrix.a)...
ar rcs libmatrix.a Src/Matrix_Methods.o Src/Matrix_Algorithms.o Src/LU.o Src/IterativeSolver.o
...
g++ -std=c++17 -Wall -IInclude -fPIC -c Src/IterativeSolver.cpp -o Src/IterativeSolver.o
echo Creating Dynamic Library (matrix.dll)...
g++ -shared -o matrix.dll Src/Matrix_Methods.o Src/Matrix_Algorithms.o Src/LU.o Src/IterativeSolver.o
...
g++ Main_Updated.cpp -L. -lmatrix -std=c++17 -Wall -IInclude -o main_updated.exe
